...
const cacheName = 'FixIt9ExtraXPBradyMitchell-2020-11-24 15:27:06.259343'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FixIt9ExtraXPBradyMitchell'.length) === 'FixIt9ExtraXPBradyMitchell') {
